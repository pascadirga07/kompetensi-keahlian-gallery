...
<div class="p-4 sm:ml-64">
    <div class="p-4 border-2 border-gray-200 border-dashed rounded-lg dark:border-gray-700 mt-14">
            <div  id="justifiedGallery">
                ...
                <a data-modal-target="modal-{{ $gallery->id }}" data-modal-show="modal-{{ $gallery->id }}" data-modal-backdrop="static">
                    <img alt="caption for image {{ $gallery->id }}" src="https://source.unsplash.com/featured/300x20{{ $gallery->id }}";/>
                    <!-- Main modal -->
