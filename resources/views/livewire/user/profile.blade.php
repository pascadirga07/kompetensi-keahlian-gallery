    ...
    <div class="p-4 sm:ml-64">
        <div class="p-4 border-2 border-gray-200 border-dashed rounded-lg dark:border-gray-700 mt-14">
            ...
            <form wire:submit="updateImage">
                <div class="mb-4">
                    @if (is_string($image))
                        <img src="{{ asset('storage/' . $image) }}" class="w-24 h-24 rounded-full">
                    @elseif (is_null($image))
                        <img src="{{ asset('profiles/500px.webp') }}" class="w-24 h-24 rounded-full">
                    @else
                        <img src="{{ $image->temporaryUrl() }}" class="w-24 h-24 rounded-full">
                    @endif
